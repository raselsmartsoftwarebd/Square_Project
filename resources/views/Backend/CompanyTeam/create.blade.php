        ...
        <div class="col-sm-12">
            <div class="widget-box">
                <div class="widget-header">
                    <h4 class="widget-title"> Team Info Create</h4>
                ...
                <div class="widget-body">
                    <div class="widget-main no-padding">
                        ...
                        <form class="form-horizontal" id="companyForm" action="{{ URL::to('companyteam') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                   ...
                                   <a href="{{ URL::to('companyteam') }}" class="btn btn-info" style="float:right;margin-right:5px;">Excellence List</a>
                                    <hr>
