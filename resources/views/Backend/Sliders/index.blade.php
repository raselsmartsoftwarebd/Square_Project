...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-edit"></i>Manage Sliders</h1>
        ...
        <div class="col-md-12">
           ...
           @endif
            ...
            <div class="tile table-responsive">
                <a href="{{ URL::to('sliders/create') }}"class="btn btn-info" style="float: right;margin-bottom:5px;">Add Sliders</a>
                <table class="table table-bordered">
                     ...
                     @foreach ($sliderss as $sliders)
                        <tr>
                            ...
                            <td>{{ $sliders->imagetitle }}</td>


                            <td>
                                <img src="{{ asset('/slidesimage/'.$sliders->slidingimage) }}" height="80" width="80"/>
                            </td>
                            ...
                            <td>
                                ...
                                <label>
                                    <input name="switch-field-1"
                                        data-id="{{$sliders->id}}" onclick="statusChange(this)"
                            ...
                            <td>
                                ...
                                <div class="edit-delete-container">
                                    <div class="edit-delete-left-section">
                                        <a href="{{ URL::to('sliders/'.$sliders->id.'/edit') }}" class="btn btn-sm btn-info edit-button"><i class="ace-icon fa fa-pencil bigger-120"></i></a>
                                    </div>
                                    <div class="edit-delete-right-section">
                                        <form action="{{ url('sliders/'.$sliders->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
