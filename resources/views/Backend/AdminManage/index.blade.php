                            ...
                            <td>
                                ...
                                <div class="edit-delete-container">
                                    <div class="edit-delete-left-section">
                                        <a href="{{ URL::to('admindetails/'.$details->id.'/edit') }}" class="btn btn-sm btn-info edit-button"><i class="ace-icon fa fa-pencil bigger-120"></i></a>
                                    </div>
                                    <div class="edit-delete-right-section">
                                        <form action="{{ url('admindetails/'.$details->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
