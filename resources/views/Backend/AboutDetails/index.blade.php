...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-edit"></i>Manage About Details</h1>
        ...
        <div class="col-md-12">
           ...
           @endif
            ...
            <div class="tile table-responsive">
                <a href="{{ URL::to('aboutdetails/create') }}"class="btn btn-info" style="float: right;margin-bottom:5px;margin-left:-5px;">Add New</a>
                <table class="table table-bordered">
                     ...
                     @foreach ($aboutdetails as $details)
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('/asset/aboutimage/'.$details->image) }}" height="80" width="80"/>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="edit-delete-container">
                                    <div class="edit-delete-left-section">
                                        <a href="{{ URL::to('aboutdetails/'.$details->id.'/edit') }}" class="btn btn-sm btn-info edit-button"><i class="ace-icon fa fa-pencil bigger-120"></i></a>
                                    </div>
                                    <div class="edit-delete-right-section">
                                        <form action="{{ url('aboutdetails/'.$details->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
...
<script>
    function statusChange(element) {
        ...
        let post_url = "/change_about_details_status";
