        ...
        <div class="widget-box">
            ...
            <div class="widget-body">
                ...
                @endif
                    ...
                    <form class="form-horizontal" id="companyForm" action="{{ url('investortitle/'.$investortitle->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-2">
                                        <div class="favicon-upload-box">
                                            <img src="{{ asset('/asset/investorimage/'.$investortitle->image)  }}"  height="100" width="100" />
                                        </div>
                                     </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 ">
                                        <input type="text" class="form-control" name="title"
                                               value="{{ $investortitle->title }}" placeholder="">
