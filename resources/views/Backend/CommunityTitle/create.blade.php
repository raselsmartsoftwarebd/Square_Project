        ...
        <div class="col-sm-12">
            <div class="widget-box">
                <div class="widget-header">
                    <h4 class="widget-title"> Community Title Create</h4>
                ...
                <div class="widget-body">
                    <div class="widget-main no-padding">
                        ...
                        <form class="form-horizontal" id="companyForm" action="{{ URL::to('communitytitle') }}" method="post" enctype="multipart/form-data">
                            @csrf
