    ...
    <div class="col-sm-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title"> News & Events Update</h4>
            ...
            <div class="widget-body">
                ...
                @endif
                    ...
                    <form class="form-horizontal" id="companyForm" action="{{ url('newsevents/'.$newsevents->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="text-center">News Events Update</h4>
                                <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-2">
                                        <div class="favicon-upload-box">
                                            <img src="{{ asset('/asset/eventsimage/'.$newsevents->image)  }}"  height="100" width="100" />
                                        </div>
                                     </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 ">
                                        <input type="text" class="form-control" name="title"
                                               value="{{ $newsevents->title }}" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 ">
                                        <input type="text" class="form-control" name="description"
                                               value="{{ $newsevents->description }}" placeholder="">
