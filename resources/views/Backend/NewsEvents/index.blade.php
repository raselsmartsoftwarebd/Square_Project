...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-edit"></i>Manage News & Events</h1>
        ...
        <div class="col-md-12">
           ...
           @endif
            ...
            <div class="tile table-responsive">
                <a href="{{ URL::to('newsevents/create') }}"class="btn btn-info" style="float: right;margin-bottom:5px;margin-left:-5px;">Add New</a>
                <table class="table table-bordered">
                     ...
                     @foreach ($newsevents as $events)
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('/asset/eventsimage/'.$events->image) }}" height="80" width="80"/>
                            </td>
                            ...
                            <td>
                                ...
                                <label>
                                    <input name="switch-field-1"
                                        data-id="{{$events->id}}" onclick="statusChange(this)"
                            ...
                            <td>
                                ...
                                <div class="edit-delete-container">
                                    <div class="edit-delete-left-section">
                                        <a href="{{ URL::to('newsevents/'.$events->id.'/edit') }}" class="btn btn-sm btn-info edit-button"><i class="ace-icon fa fa-pencil bigger-120"></i></a>
                                    </div>
                                    <div class="edit-delete-right-section">
                                        <form action="{{ url('newsevents/'.$events->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
...
<script>
    function statusChange(element) {
        ...
        let post_url = "/change_events_status";
