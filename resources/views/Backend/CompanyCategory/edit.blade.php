    ...
    <div class="col-sm-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title"> Company Category Update</h4>
            ...
            <div class="widget-body">
                ...
                @endif
                    ...
                    <form class="form-horizontal" id="companyForm" action="{{ url('companycategory/'.$companycategory->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="text-center">Company Category Update</h4>
                                <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 ">
                                        <input type="text" class="form-control" name="name"
                                               value="{{ $companycategory->name }}" placeholder="">
